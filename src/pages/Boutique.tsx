    ...
    () => [
      {
        ...
        image:
          "https://images.unsplash.com/photo-1559525823-59bbe209abf0?q=80&w=1000&auto=format&fit=crop",
      },
      {
        id: 2,
        ...
        price: "38€",
        description:
          "Café en grains à la saveur corsée et puissante, idéal pour les amateurs de café fort.",
        image:
          "https://images.unsplash.com/photo-1618245479237-160d88a2ef4e?q=80&w=1000&auto=format&fit=crop",
      },
      {
        id: 3,
        name: "Mélange Maison",
        ...
        image:
          "https://images.unsplash.com/photo-1605701250441-2bfa95e9c44d?q=80&w=1000&auto=format&fit=crop",
      },
      {
        id: 4,
      ...
      },
      {
        ...
        image:
          "https://images.unsplash.com/photo-1607681034540-2c46cc71896d?q=80&w=1000&auto=format&fit=crop",
      },
      {
        id: 6,
  ...
  return (
    <Box bg={bgColor} color={textColor} minH="100vh">
      <Box py={8} px={4}>
        ...
        {keyboardMode && (
          <Box bg="brown.50" p={4} mb={8} borderRadius="md" aria-live="polite">
            <Text>
              Utilisez les flèches du clavier pour naviguer entre les produits. Appuyez sur Entrée
              pour sélectionner.
            </Text>
          </Box>
        )}
          ...
          {products.map((product, index) => (
            ...
            >
              ...
              <Box p={6}>
                ...
                <Text fontSize="xl" fontWeight="bold" mb={2} color="brown.400">
                  {product.price}
                </Text>
